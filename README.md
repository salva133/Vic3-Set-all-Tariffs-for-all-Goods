...
## Features
- Set tariffs for **all goods**
- Four tariff levels:
  - No tariffs or subventions (zero)
  - Low tariffs
  - High tariffs
  - Maximum tariffs
...
## How to Use
1. Play as a country that leads a market.
2. Go to your **Decisions** panel.
3. Select **"Set Tariffs"**.
